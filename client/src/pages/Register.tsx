    ...
    <div className="min-h-screen flex items-center justify-center p-6 neo-blur overflow-hidden relative">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-3xl font-bold bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">Join Us</h2>
          <p className="text-gray-400 mt-2">Create your workspace today</p>
        </div>
